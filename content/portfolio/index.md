+++
title = "Portfolio"
description = "A collection of things I've built — from web apps to CLI tools."
[extra]
styles = ["portfolio/style.css"]
+++

I work with **TypeScript**, **React**, **Next.js**, and **Rust** — among other things. Here's a selection of what I've built so far.
...
<span class="project-icon">{{ icon(name="cloud") }}</span>
<strong>Personal CDN</strong>
</div>
<div class="tech-tags">
...
<div class="project-header">
<div class="project-title">
<span class="project-icon">{{ icon(name="plugs-connected") }}</span>
<strong>mcp-memos</strong>
</div>
<div class="tech-tags">
...
<div class="project-header">
<div class="project-title">
<span class="project-icon">{{ icon(name="chart-bar") }}</span>
<strong>VoteTracker</strong>
</div>
<div class="tech-tags">
...
<div class="project-header">
<div class="project-title">
<span class="project-icon">{{ icon(name="detective") }}</span>
<strong>Gioffydex</strong>
</div>
<div class="tech-tags">
...
<div class="project-header">
<div class="project-title">
<span class="project-icon">{{ icon(name="clock-counter-clockwise") }}</span>
<strong>Game Rewind</strong>
</div>
<div class="tech-tags">
...
<div class="project-header">
<div class="project-title">
<span class="project-icon">{{ icon(name="browser") }}</span>
<strong>mambuco.dev</strong>
</div>
<div class="tech-tags">
<span class="tech-tag">Zola</span>
