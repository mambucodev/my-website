      ...
      switch (status) {
        case "online": {
          ...
          playersListElement.innerHTML = data.players.list.length > 0 ?
            data.players.list.map(player => `<li><img class="emoji" height="24" src="https://mineskin.eu/helm/${player.name_clean}/50.png" title="${player.name_raw}'s head" width="24"> ${player.name_raw}</li>`).join("") :
